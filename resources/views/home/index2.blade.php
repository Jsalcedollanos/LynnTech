            ...
            <div class="aa-header-top-area">
              ...
              <div class="aa-header-top-left">
                ...
                <div class="aa-language">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <img src="img/flag/english.jpg" alt="english flag">ESPAÑOL
                ...
                <div class="aa-currency">
                  <div class="dropdown">
                    <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                      <i class="fa fa-usd"></i>Pesos Colombiano
                      <span class="caret"></span>
                    </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
        ...
        <div class="navbar navbar-default" role="navigation">
          ...
          <div class="navbar-collapse collapse">
            ...
            <ul class="nav navbar-nav">
              ...
              <li><a href="{{ route('tienda.index') }}?busqueda=Vestidos">Vestidos <span class="caret"></span></a>
              ...
              <li><a href="{{ route('tienda.index') }}?busqueda=Batola">Batolas <span class="caret"></span></a>
              <ul class="dropdown-menu">                
              ...
              <li><a href="{{ route('tienda.index') }}?busqueda=Conjunto">Conjunto</a></li>
                ...
                <div class="aa-promo-left">
                  <div class="aa-promo-banner">                    
                    ...
                    <div class="aa-prom-content">
                      <span>Vestido Tematico</span>
                      <h4><a href="#">Ver mas</a></h4>                      
                    </div>
                  </div>
                </div>
              </div>
                        ...
                        <li>
                          <figure>
                            ...
                            <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Agregar al carrito</a>
                              <figcaption>
                              <h4 class="aa-product-title"><a href="#">Vestido de Freesia</a></h4>
                              <span class="aa-product-price">$250.000</span><span class="aa-product-price"><del>$265.000</del></span>
                            </figcaption>
                          </figure>                        
