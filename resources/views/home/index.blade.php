              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade in active" id="masvendido">
                  <ul class="aa-product-catg aa-popular-slider">
                    ...
                    @if ($producto -> etiqueta == "Mas vendido")             
                    <li>
                      <figure>
                        ...
                        <a class="aa-add-card-btn"href="#"><span class="fa fa-shopping-cart"></span>Agregar al Carrito</a>
                         <figcaption>
                          ...
                          <span class="aa-product-price">Ahora: ${{$producto->valor}}</span><br>
                          <span class="aa-product-price">Antes:<del> ${{$producto->descuento}}</del></span>
                        </figcaption>
                      </figure>                     
                  ...
                  <a class="aa-browse-btn" href="#">Ver todos estos productos <span class="fa fa-long-arrow-right"></span></a>
                </div> 
